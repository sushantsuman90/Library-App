...
export default function E_resources({navigation}) {
  return (
    ...
    <View style={{padding:5, left:5, }}>
      <TouchableOpacity onPress={()=>{Linking.openURL('https://www.iust.ac.in/departmentcontent/LIB/documents/637825212074641682.pdf#toolbar=0')}}>
    ...
    <View style={{padding:5, left:5,}}>
    <TouchableOpacity onPress={()=>{Linking.openURL('https://www.iust.ac.in/departmentcontent/LIB/documents/637933214323532394.pdf#toolbar=0')}}>
       <Surface style={styles.surface} elevation={4}>
       <Image source={pdf} style={styles.icon}/>
